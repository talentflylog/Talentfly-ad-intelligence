...
[{"headline":"...","primary_text":"...","cta":"...","why_win":"...","hook_type":"offer|fear|aspiration|social_proof"}]`
  ...
  try {
    ...
    // Fallback creatives if JSON parsing fails
    return res.status(200).json({
      creatives: [
        {
          headline: `${brand} — Free Demo Class!`,
          primary_text: `Join ${brand} and launch your career in ${course || 'professional courses'}. ${offer || 'Free demo class available'}. Limited seats — register now!`,
          cta: 'Sign Up',
          why_win: 'Free offer removes hesitation',
          hook_type: 'offer',
        },
        {
          headline: `₹40,000/Month After Our Course`,
          primary_text: `${brand}'s ${course || 'certification course'} gets you job-ready fast. Our students earn an average of ₹38,000/month. Gulf placements available. ${offer || ''}`,
          cta: 'Learn More',
          why_win: 'Specific salary creates strong aspiration',
          hook_type: 'aspiration',
        },
        {
          headline: `500+ Students Placed — Join Us`,
          primary_text: `Don't miss out! ${brand} has placed 500+ students at top companies. ${offer || 'Free counseling available'}. Your success story starts here.`,
          cta: 'Contact Us',
          why_win: 'Social proof builds immediate trust',
