...
export default async function handler(req, res) {
  ...
  const { campaignName, objective, adsetName, dailyBudget, ageMin, ageMax, gender,
          pageId, headline, primaryText, destinationUrl, imageUrl, ctaType } = req.body;
  ...
  try {
    ...
    log.push(`✅ Ad: ${ad.id}`);
    log.push('🎉 Campaign created successfully in PAUSED state!');
